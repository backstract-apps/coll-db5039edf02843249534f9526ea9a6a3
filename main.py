...
app = FastAPI(title='Backstract Generated APIs - coll-db5039edf02843249534f9526ea9a6a3', debug=False,
              docs_url='/awesome-buck-8ed9e058eaa511efab560242ac12000531/docs',
              openapi_url='/awesome-buck-8ed9e058eaa511efab560242ac12000531/openapi.json')
...
app.include_router(
    router,
    prefix='/awesome-buck-8ed9e058eaa511efab560242ac12000531/api',
    tags=['APIs v1']
)
